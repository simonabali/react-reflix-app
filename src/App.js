      ...
      <div className="App">
        <Router>
          <div>
            ...
            <Route exact path="/catalog" render={() => <Catalog movies={this.state.movies} changeRented = {this.changeRented} />} />
